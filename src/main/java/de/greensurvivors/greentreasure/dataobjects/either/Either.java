package de.greensurvivors.greentreasure.dataobjects.either;
...
public abstract class Either<L, R> {
     ...
     *
     * @param leftConsumer  action to consume if this is a Left
     * @param rightConsumer action to consume if this is a Right
     */
     ...
     * @param rightConsumer action to consume if this is a Right
     */
    public abstract <E extends Exception> void consumeExceptionally(
